...
#Handle March-1 Sept-1 Excel autoconversion
...
class DE_rpy2:
    ...
    def run_deseq2(self):
        ...
        count_data <- round(count_data) #Round to integer
...
if uploaded_file is not None:
    ...
    with st.sidebar:
        ...
        st.markdown("""Excluding low-expression genes improves FDR calculation.
        If many genes are filtered out, uncheck this option to rank all genes for GSEA.""")
        min_threshold = 0
        max_threshold = 0
    ...
    # Select rows containing at least one non-numeric element
