...
with col1:
    uploaded_h5ad = st.file_uploader(
        ...
        help="h5ad file processed with Seurat/Scanpy"
    )
...
if uploaded_h5ad is not None and uploaded_loom is not None:
    ...
    with st.expander("📚 Parameter Guide", expanded=False):
        ...
        - **n_neighbors**: Number of neighboring cells (default: 30)

        ### velocity
        - **mode**: Calculation mode
          - **dynamical** (recommended): Most accurate, complete modeling of transcriptional dynamics. Recommended in the original paper
          - **stochastic**: Fastest, simplified analysis
          - **deterministic**: Intermediate

        - **n_jobs**: Number of CPU cores for parallel computation (only effective in dynamical mode)
          - For 32-core systems, approximately 24 cores are recommended (balance with memory usage)

        ### PAGA (Partition-based graph abstraction)
        - Computes connectivity between clusters and abstracts differentiation trajectories
        - When combined with velocity graph, directed PAGA is computed
        - Requires cluster information (categorical variables in adata.obs)
    ...
    with st.form("analysis_params_form"):
        ...
        with col1:
            min_shared_counts = st.number_input(
                ...
                max_value=100,
                value=20,
                help="Minimum count number used for filtering both genes and cells"
            )
            ...
            retain_genes_str = st.text_area(
                ...
                help="Gene names to always retain regardless of HVG selection (supports multiple delimiters: comma, space, tab, newline)"
            )
        ...
        with col2:
            n_pcs = st.number_input(
                ...
                max_value=100,
                value=30,
                help="Number of components used in principal component analysis"
            )
            ...
            n_neighbors = st.number_input(
                ...
                max_value=100,
                value=30,
                help="Number of neighboring cells used for neighbor graph construction"
            )
        ...
        with col1:
            ...
            st.caption("💡 DeepVelo can be used in a separate app (DeepVelo analysis)")
        ...
        compute_paga = st.checkbox(
            "Compute PAGA",
            value=True,
            help="Compute Partition-based graph abstraction (requires cluster information)"
        )
        ...
        if compute_paga:
            if not categorical_cols:
                ...
                paga_cluster_key = st.selectbox(
                    ...
                    categorical_cols,
                    index=default_index,
                    help="Select cluster information to use for PAGA computation"
                )
                        ...
                        try:
                            ...
                            if "mismatching number of index arrays" in error_msg:
                                ...
                                **⚠️ Known scvelo bug detected**
                                ...
                                This error is a known bug that exists in scvelo v0.3.4 and earlier.
                                ...
                                **🔧 How to fix:**
                                ...
                                You can fix this bug by editing the following file:
                                ...
                                **After:**
                                ...
                                Please restart this app after making the fix.
                                """)
    ...
    if st.session_state.analysis_complete:
        ...
        1. Navigate to **scVelo Visualization** page
        ...
        - **Pseudotime gene expression**: Visualize gene expression trends
        """)

else:
    st.info("👆 Please upload both h5ad and loom files to begin")
